...
CREATE TABLE IF NOT EXISTS `mydb`.`tbla_modelo` (
  ...
  INDEX `fk_tbla_modelo_tbla_marca1_idx` (`tbla_marca_idmarca` ASC) VISIBLE,
  CONSTRAINT `fk_tbla_modelo_tbla_marca1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbla_estado_solicitud` (
  ...
  INDEX `fk_tbla_estado_solicitud_tbla_total1_idx` (`tbla_total_idtotal` ASC) VISIBLE,
  CONSTRAINT `fk_tbla_estado_solicitud_tbla_total1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_Solicitud` (
  ...
  `tbl_oficina_idoficina1` INT NOT NULL,
  ...
  INDEX `fk_tbl_Solicitud_tbl_oficina2_idx` (`tbl_oficina_idoficina1` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tbl_Solicitud_tbla_estado_solicitud1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_Solicitud_tbl_oficina2`
    FOREIGN KEY (`tbl_oficina_idoficina1`)
    REFERENCES `mydb`.`tbl_oficina` (`idoficina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tbl_precio_por_dia` (
  ...
  INDEX `fk_Tbl_precio_por_dia_TBLA_segurobasico1_idx` (`TBLA_segurobasico_idsegurobasico` ASC) VISIBLE,
  CONSTRAINT `fk_Tbl_precio_por_dia_TBLA_segurobasico1`
